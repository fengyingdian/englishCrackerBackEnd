$(function(){
	...
	function checkAccount(username){
		if (username == '') {
			$('.num-err').removeClass('hide').find("em").text('璇疯緭鍏ヨ处鎴�');
			return false;
		} else {
	...
	function checkPass(pass){
		if (pass == '') {
			$('.pass-err').removeClass('hide').text('璇疯緭鍏ュ瘑鐮�');
			return false;
		} else {
	...
	function checkPhone(phone){
		var status = true;
		if (phone == '') {
			$('.num2-err').removeClass('hide').find("em").text('璇疯緭鍏ユ墜鏈哄彿');
			return false;
		}
	...
	function checkPhoneCode(pCode){
		if (pCode == '') {
			$('.error').removeClass('hide').text('璇疯緭鍏ラ獙璇佺爜');
			return false;
		} else {
			$('.error').addClass('hide');
			return true;
