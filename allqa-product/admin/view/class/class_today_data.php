    ...
    BUI.use(['common/search','bui/overlay'],function (Search,Overlay) {
        ...
        columns = [
            ...
            {title : '操作',dataIndex:'',renderer : function(value,obj){
                return '<a href=/view/student/today_data.php?id='+obj.id+' class="grid-command btn-delete"  title="当日数据">当日数据</a>' +
                    '<a href=/view/student/history_data.php?id='+obj.id+' class="grid-command btn-delete"  title="历史数据">历史数据</a>'
            },width:200},
        ],
