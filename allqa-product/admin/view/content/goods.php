...
<div class="container">
    ...
    <div class="demo-content">
        <div class="doc-content">
            <ul class="nav-tabs">
                <li class="active"><a href="/view/content/goods.php?system_id=1">备战高考</a></li>
                ...
                <li><a href="/view/content/goods_toefl.php?system_id=4">托福/雅思</a></li>
            </ul>
        </div>
    </div>
        ...
        columns = [
            ...
            {title : '操作',dataIndex:'status',renderer : function(value,obj){
                    return '<a class="btn btn-danger">删除</a> ' +
                        '<a href=/view/content/goods_edit.php?id='+obj.id+' class="grid-command btn-delete"  title="编辑">编辑</a>' +
