...
<div>
    <div style='margin-left: 30px;margin-top: 20px;margin-bottom: 0px;'>
        <button id="btnShow" class="button button-primary">添加真题阅读</button>
    </div>
</div>
...
<script type="text/javascript">
    ...
    BUI.use(['common/search','bui/overlay'],function (Search,Overlay) {
        columns = [
            ...
            {title : '中文标题',dataIndex :'title',width:100},
            {title : '英文标题',dataIndex :'title_en',width:100},
            ...
            {title : '操作',dataIndex:'id',renderer : function(value,obj){
                return '<a class="btn btn-danger">删除</a> '+' <a href=/view/content/oldexam_edit.php?id='+obj.id+'>编辑</a>';
            },width:150},
        ];
        store = Search.createStore(
            '/content/oldexam_list',
            {
        ...
        $('#btnShow').on('click',function () {
            window.location.href="/view/content/oldexam_add.php";
        });
    });
</script>
<body>
