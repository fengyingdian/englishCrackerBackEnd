...
<div>
    <div style='margin-left: 30px;margin-top: 20px;margin-bottom: 0px;'>
        <button id="btnShow" class="button button-primary">添加期刊</button>
    </div>
...
<script type="text/javascript">
    ...
    BUI.use(['common/search','bui/overlay'],function (Search,Overlay) {
        columns = [
            ...
            {title : '出处',dataIndex :'source',width:100},
            {title : '中文标题',dataIndex :'cn_title',width:80},
            {title : '英文标题',dataIndex :'en_title',width:80},
            {title : '字数',dataIndex :'number',width:50},
            {title : '讲义作者',dataIndex :'author',width:80},
            ...
            {title : '操作',dataIndex:'id',renderer : function(value,obj){
                return '<a class="btn btn-danger">删除</a> '+' <a href=/view/content/periodical_edit.php?id='+obj.id+'>编辑</a>';
            },width:100},
        ];
        store = Search.createStore(
            '/content/periodical_list',
            {
    ...
    BUI.use(['bui/overlay','bui/form'],function(Overlay,Form){
        ...
        $('#btnShow').on('click',function () {
            window.location.href="/view/content/periodical_add.php";
        });
    });
</script>
<body>
