...
<div class="demo-content">
    <form id="J_Form" action="/content/periodical_add" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="pnumber" type="text" class="input-large" data-rules="{required : true}">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class="input-large" name="number" data-rules="{required : true}">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class="input-large" name="author" data-rules="{required : true}">
            </div>
        </div>
...
<!--                <textarea name="content[]" id="content_1" class="control-row4 input-large"></textarea>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div id="parent"></div>-->
        ...
        <div class="control-group">
            ...
            <div class="controls  control-row-auto" style="width:700px">
                <script id="container" name="teaching" type="text/plain"></script>
                <!-- 配置文件 -->
